...
const Faq = () => {
    return (
        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 ">
            <div class=" mb-8 lg:mb-16 flex flex-col ">
                <h2 class="animate-jump-in mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white mt-3">Preguntas frecuentes</h2>
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    <h3 class="mb-2 text-xl font-bold dark:text-white">¿Cuánto tiempo de garantía ofrece en las reparaciones?</h3>
                ...
                <div>
                    <h3 class="mb-2 text-xl font-bold dark:text-white">¿Trabajan con todas las marcas y modelos de teléfonos?</h3>
                ...
                <div>
                    <h3 class="mb-2 text-xl font-bold dark:text-white">¿Qué métodos de pago aceptan?</h3>
                ...
                <div>
                    <h3 class=" mb-2 text-xl font-bold dark:text-white">¿Cómo puedo eliminar información personal de mi dispositivo antes de llevarlo para reparación?</h3>
                ...
                <div>
                    <h3 class="mb-2 text-xl font-bold dark:text-white">¿Cuáles son las medidas de seguridad adoptadas para proteger la privacidad de mis datos?</h3>
                ...
                <div>
                    <h3 class="mb-2 text-xl font-bold dark:text-white">¿El diagnóstico es gratuito?</h3>
                ...
                <div>
                    <h3 class="mb-2 text-xl font-bold dark:text-white">¿Cuánto tiempo lleva una reparación en promedio?</h3>
                    <p class="text-gray-500 dark:text-gray-400">Keep your company’s lights on with customizable, iterative, and structured workflows built for all efficient teams and individual.</p>
                </div>
                <div>
                    <h3 class="mb-2 text-xl font-bold dark:text-white">¿Es necesario pedir cita previa?</h3>
                    <p class="text-gray-500 dark:text-gray-400">Keep your company’s lights on with customizable, iterative, and structured workflows built for all efficient teams and individual.</p>
                </div>
                <div>
                    <h3 class="mb-2 text-xl font-bold dark:text-white">¿Hay solución para un móvil mojado?</h3>
                    <p class="text-gray-500 dark:text-gray-400">Keep your company’s lights on with customizable, iterative, and structured workflows built for all efficient teams and individual.</p>
                </div>
            </div>
        </div>
