    ...
    <section className="bg-dark-900 p-0 mt-5 sm:mt-5">
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7 w-full">
          ...
          <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Tu móvil merece una segunda oportunidad, confía en nosotros para su reparación, visítanos o solicita tu presupuesto</p>
        ...
        <div className="lg:mt-0 lg:col-span-5 lg:flex w-full">
          <img src={iphone13} className="w-full" alt="iPhone 13" />
        </div>
      </div>
    </section>
  );
