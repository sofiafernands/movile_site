...
function RepairCourses() {
    ...
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        <div class="grid grid-cols-2 gap-4 mt-8">
            ...
            <img class="mt-4 w-full lg:mt-10 rounded-lg" src={courses} alt="office content 2"/>
        </div>
        <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            <h2 class="mb-4 mt-4 text-4xl tracking-tight font-extrabold text-white dark:text-white">Forma tu Futuro en la Reparación Móvil con Nuestros Cursos Especializados en Microsoldadura</h2>
            ...
            <p class="text-white">Nuestros cursos personalizados te permitirán dominar la microsoldadura y te prepararán para una carrera en reparación móvil, donde la demanda de expertos en reparación móvil está en constante aumento.</p>
            <Link to="/">
                <button type="button"
