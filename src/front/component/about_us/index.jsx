...
function AboutUs () {
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Comprometidos con la Calidad y la Satisfacción del Cliente</h2>
...
Esto proporciona una visión general de lo que ofreces y establece una base sólida para el listado de checks que planeas incluir a continuación.</p>
      ...
      <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          ...
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              <h3 class="mb-4 text-2xl font-semibold">Garantia</h3>
              <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Responsabilidad de nuestra parte.</p>
          ...
          {/* <!-- Pricing Card --> */}
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              <h3 class="mb-4 text-2xl font-semibold">Experiencia</h3>
              <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Sabemos lo importante que es para ti.</p>
          ...
          {/* <!-- Pricing Card --> */}
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              <h3 class="mb-4 text-2xl font-semibold">Mejores precios</h3>
              <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">La mejor calidad a los mejores precios</p>
