...
.</p>
      ...
      <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          ...
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              <h3 className="mb-4 text-2xl font-semibold">Garantia</h3>
              <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Responsabilidad de nuestra parte.</p>
          ...
          {/* <!-- Pricing Card --> */}
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              <h3 className="mb-4 text-2xl font-semibold">Experiencia</h3>
              <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">Sabemos lo importante que es para ti.</p>
          ...
          {/* <!-- Pricing Card --> */}
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              <h3 className="mb-4 text-2xl font-semibold">Mejores precios</h3>
              <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">La mejor calidad a los mejores precios</p>
