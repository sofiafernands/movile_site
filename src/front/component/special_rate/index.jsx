...
<section className="bg-gray-700 ">
    ...
    <div className=" lg:mt-0 lg:col-span-5 lg:flex mr-5">
            <img src={company} alt="mockup" classNameName="rounded-5"/>
        </div>   
        <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <Link to="formCompany" className="bg-blue-300 inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100">
