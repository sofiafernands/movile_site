...
import iphonesXR from '../../img/iphonesXR.jpg';
 ...
 <section className="bg-dark-900 dark:bg-gray-900">
    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="animate-pulse max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Expertos en Recuperación de Datos Móviles: Tu Solución Confiable</h1>
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-2 md:text-lg lg:text-xl dark:text-gray-400">Confía en nuestra experiencia para recuperar tus datos móviles perdidos. Con años de conocimiento en la industria, estamos preparados para ayudarte a restaurar tus archivos importantes. Recupera tus datos con nosotros hoy mismo</p>
        ...
        <img src={iphonesXR} style={{height:'500px', width:'360px'}} className="object-cover" alt="mockup"/>
        </div>   
